...
/**
 * Extension function to safely get a property as String from SoapObject
 */
private fun org.ksoap2.serialization.SoapObject.getPropertySafelyAsString(name: String): String? {
    return try {
